...
function CommentsCommentElementNetwork(props:CommentsCommentElementNetworkProps){
   ...
   <Rect x={props.touchpoint.x} y={props.touchpoint.y + 40} height={90} width={150} stroke={"gray"}  fill='lightgray'/>
        <TextMessages x={props.touchpoint.x + 5} y={props.touchpoint.y+ 45} width={138} height={20} ChangeFunction={(value: any) => { changeComments(value) }} value={props.touchpoint.Comment.text}
          fontSize={14} modifyObject={props.touchpoint} isEditing={props.touchpoint.Comment.isEdit}
